...
namespace Backend.Migrations
{
    ...
    [Migration("20260218133209_MakeRadiusProfileOptionalAddAutomation")]
    partial class MakeRadiusProfileOptionalAddAutomation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Models.AutomationExecutionLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("NodesVisited")
                        .HasColumnType("integer");

                    b.Property<int?>("RadiusUserId")
                        .HasColumnType("integer");

                    b.Property<Guid?>("RadiusUserUuid")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AutomationId", "TriggerType", "CreatedAt");

                    b.ToTable("AutomationExecutionLogs");
                });

            modelBuilder.Entity("Backend.Models.AutomationExecutionStep", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("HttpResponseStatusCode")
                        .HasColumnType("integer");

                    b.Property<long?>("HttpResponseTimeMs")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ExecutionLogId", "StepOrder");

                    b.ToTable("AutomationExecutionSteps");
                });
            ...
            modelBuilder.Entity("Backend.Models.IntegrationWebhook", b =>
                {
                    ...
                    b.Property<bool>("CallbackEnabled")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Backend.Models.Management.AuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("EntityType", "EntityUuid");
            ...
            modelBuilder.Entity("Backend.Models.Management.SystemNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<Guid?>("ReferenceEntityUuid")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ReferenceEntityUuid");
            ...
            modelBuilder.Entity("Backend.Models.Payments.PaymentForceCompletion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("PaymentForceCompletions");
                });
            ...
            modelBuilder.Entity("Backend.Models.RadiusActivation", b =>
                {
                    ...
                    b.Property<string>("ProfileChangeType")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");
                    ...
                    b.Property<DateTime?>("ScheduledProfileChangeDate")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Backend.Models.RadiusUserHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Backend.Models.SasRadiusIntegration", b =>
                {
                    ...
                    b.Property<bool>("CheckCardAvailabilityBeforeActivate")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Backend.Models.UserWallet", b =>
                {
                    ...
                    b.Property<string>("CustomCashbackCollectionSchedule")
                        .HasColumnType("text");

                    b.Property<decimal?>("CustomCashbackMinimumCollectionAmount")
                        .HasColumnType("numeric");

                    b.Property<bool?>("CustomCashbackRequiresApproval")
                        .HasColumnType("boolean");

                    b.Property<string>("CustomCashbackType")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Backend.Models.AutomationExecutionStep", b =>
                {
                    b.HasOne("Backend.Models.AutomationExecutionLog", "ExecutionLog")
                        .WithMany("Steps")
            ...
            modelBuilder.Entity("Backend.Models.Payments.PaymentForceCompletion", b =>
                {
                    b.HasOne("Backend.Models.Payments.PaymentLog", "PaymentLog")
                        .WithMany()
