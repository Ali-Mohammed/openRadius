...
namespace Backend.Migrations.ApplicationDb
{
    ...
    [Migration("20260123171842_AddTransactionCashbackIndexes")]
    partial class AddTransactionCashbackIndexes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Backend.Models.BillingActivation", b =>
                {
                    ...
                    b.Property<int?>("RadiusActivationId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Backend.Models.BillingActivation", b =>
                {
                    ...
                    b.HasOne("Backend.Models.RadiusActivation", "RadiusActivation")
                        .WithMany()
