...
import { Plus, Pencil, Trash2, RefreshCw, Search, ChevronLeft, ChevronRight, Archive, RotateCcw, Columns3, ArrowUpDown, ArrowUp, ArrowDown, Download, FileSpreadsheet, FileText, Wifi } from 'lucide-react'
  ...
  return (
    <div className="space-y-2 overflow-x-hidden">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">FATs</h1>
          <p className="text-sm text-muted-foreground">Manage Fiber Access Terminals</p>
        </div>
